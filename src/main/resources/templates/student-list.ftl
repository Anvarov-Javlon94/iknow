                ...
                <ul>
                    ...
                    <li>
                        <form action="/search-student" method="post">
                            <input type="text" placeholder="search user" name="student-name">
            ...
            <div class="jumbotron">
                <table class="table">
                    ...
                    <#list students as k,v>
                      ...
                      <#if isAdmin><th><a href="/delete/${k.getId()}"><input type="submit" name="id" value="delete"></a></th></#if>
                      <#if isAdmin><th><a href="/edit/${k.getId()}"><input type="submit" name="id" value="edit"></a></th>     </#if>
